    ...
    <div className="bg-white rounded-xl shadow overflow-hidden">
      ...
      <table className="min-w-full text-sm">
        <thead className="bg-gray-50 border-b">
          <tr>
            <th className="px-4 py-2 text-left font-medium text-gray-700">Curso</th>
            <th className="px-4 py-2 text-left font-medium text-gray-700">Qtde. transcrições</th>
            <th className="px-4 py-2 text-left font-medium text-gray-700">Discentes atendidos</th>
            <th className="px-4 py-2 text-left font-medium text-gray-700">Sentimento médio</th>
            <th className="px-4 py-2 text-left font-medium text-gray-700">Principais temas</th>
          </tr>
        </thead>
        <tbody>
          {byCourse.map((c) => {
