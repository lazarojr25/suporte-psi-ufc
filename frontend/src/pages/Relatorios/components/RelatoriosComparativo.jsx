export default function RelatoriosComparativo({ comparativo, maxComparativo }) {
  return (
    <div className="bg-white rounded-xl shadow p-3 sm:p-4 lg:col-span-2">
      <h2 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">
        Solicitações x Atendimentos concluídos
      </h2>
      {!comparativo.length ? (
        <p className="text-sm text-gray-500">Sem dados para comparação.</p>
      ) : (
        <div className="min-w-full">
          <div className="flex items-end gap-3 sm:gap-4 h-40 sm:h-48">
          ...
          <div className="flex items-center gap-3 mt-2 sm:mt-3 text-[10px] sm:text-[11px] text-gray-600">
